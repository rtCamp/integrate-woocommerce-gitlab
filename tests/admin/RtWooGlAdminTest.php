...
class RtWooGlAdminTest extends PHPUnit_Framework_TestCase {
	...
	/**
	 * Generated from @assert ( 'http://git.rtcamp.com/api/v3/', 'HkFtzhCuc81LyVWewu18' ) == array( 'result' => 'success', 'message' => 'Connection Successful.' ).
	 *
	 * @covers RtWooGlAdmin::test_connection
	 */
	public function testTest_connection() {
		$this->assertEquals(
				array('result' => 'success', 'message' => 'Connection Successful.'), $this->object->test_connection('http://git.rtcamp.com/api/v3/', 'HkFtzhCuc81LyVWewu18')
		);
	}
	...
	/**
	 * Generated from @assert ( 'fggrg', 'HkFtzhCuc81LyVWewu18' ) == array( 'result' => 'error', 'message' => 'Connection Failed. API Endpoint URL is invalid.' ).
	 *
	 * @covers RtWooGlAdmin::test_connection
	 */
	public function testTest_connection3() {
		$this->assertEquals(
				array('result' => 'error', 'message' => 'Connection Failed. API Endpoint URL is invalid.'), $this->object->test_connection('fggrg', 'HkFtzhCuc81LyVWewu18')
		);
	}
	...
	/**
	 * Generated from @assert ( 'http://google.com', 'HkFtzhCuc81LyVWewu18' ) == array( 'result' => 'error', 'message' => 'Connection Failed. Invalid API Endpoint/Token. Please verify.' ).
	 *
	 * @covers RtWooGlAdmin::test_connection
	 */
	public function testTest_connection5() {
		$this->assertEquals(
				array('result' => 'error', 'message' => 'Connection Failed. Invalid API Endpoint/Token. Please verify.'), $this->object->test_connection('http://google.com', 'HkFtzhCuc81LyVWewu18')
		);
	}
